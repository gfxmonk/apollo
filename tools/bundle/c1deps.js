...
var Dynamic = {
  ...
  collapse: function() { return []; },  // Return all non-dynamic children
...
Seq.prototype.collapse = function() { return this.a.collapse().concat(this.b.collapse()); };
...
Call.prototype.collapse = function() {
  var call_args = [];
  var args = this.args;
  var prop = this.prop;
