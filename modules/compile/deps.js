...
Scope.prototype.end = function() {
  var seen_references = this.pctx.current_stmt.seen_references;
  for (var i=0; i<this.identifiers.length; i++) {
    var ident = this.identifiers[i];
    var seen = false;
    for (var ir = 0; ir<seen_references.length; ir++) {
      if(seen_references[ir].dest === ident) {
        seen = true;
        break;
      }
    }
...
var Statement = function() {
  ...
  this.stmt = null;
  // tracks all seen references, even if they later get unref'd
